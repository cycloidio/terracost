...
//go:generate go run github.com/golang/mock/mockgen -destination=../mock/product_repository.go -mock_names=Repository=ProductRepository -package mock github.com/cycloidio/terracost/product Repository
